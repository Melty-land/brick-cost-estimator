...
async function main() {
  ...
  // ---- 5. 库存联动:C17(上存) 2->4,库存 E17 = 上存4+进料3-本期用料3000 = -2993 ----
  await setFx('C17', '4');
  if ((await cellText('E17')) !== '-2993') { console.error('✗ 库存联动失败'); process.exit(1); }
  console.log('✓ 库存联动:库存 = 上存4+进料3-本期用料3000 = -2993(口径:上存+进料-本期用料数量)');
